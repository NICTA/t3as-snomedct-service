...
@XmlRootElement(name = "NegConcepts")
public class NegConcepts {

    @XmlAttribute(name = "Count", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String count;
    @XmlElement(name = "NegConcept", required = true)
    protected List<NegConcept> negConcept;
    ...
    /**
     * Gets the value of the negConcept property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the negConcept property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNegConcept().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<NegConcept> getNegConcept() {
        if (negConcept == null) {
            negConcept = new ArrayList<NegConcept>();
        }
        return this.negConcept;
    }
