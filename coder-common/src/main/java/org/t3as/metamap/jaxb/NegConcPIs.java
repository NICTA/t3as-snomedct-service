...
@XmlRootElement(name = "NegConcPIs")
public class NegConcPIs {

    @XmlAttribute(name = "Count", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String count;
    @XmlElement(name = "NegConcPI", required = true)
    protected List<NegConcPI> negConcPI;
    ...
    /**
     * Gets the value of the negConcPI property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the negConcPI property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNegConcPI().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<NegConcPI> getNegConcPI() {
        if (negConcPI == null) {
            negConcPI = new ArrayList<NegConcPI>();
        }
        return this.negConcPI;
    }
