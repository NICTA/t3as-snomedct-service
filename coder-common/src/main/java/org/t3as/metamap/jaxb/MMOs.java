...
@XmlRootElement(name = "MMOs")
public class MMOs {

    @XmlElement(name = "MMO", required = true)
    protected List<MMO> mmo;

    /**
     * Gets the value of the mmo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the mmo property.
     * 
     * <p>
     ...
     * 
     */
    public List<MMO> getMMO() {
        if (mmo == null) {
            mmo = new ArrayList<MMO>();
        }
        return this.mmo;
    }
