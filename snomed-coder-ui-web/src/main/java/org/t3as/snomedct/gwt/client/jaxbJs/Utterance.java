...
public class Utterance extends JavaScriptObject {

    protected Utterance() { }

    public final native String getUttText() /*-{ return this.UttText; }-*/;

    public final native Phrases getPhrases() /*-{ return this.Phrases; }-*/;
}
