...
public class SemanticType extends JavaScriptObject {

    protected SemanticType() { }

    public native final boolean isOnByDefault() /*-{ return this.onByDefault; }-*/;

    public native final String getCode() /*-{ return this.code; }-*/;

    public native final String getDescription() /*-{ return this.description; }-*/;

    public native final boolean isSelected() /*-{ return this.isSelected; }-*/;

    public native final void setSelected(final boolean isSelected) /*-{ this.isSelected = isSelected; }-*/;
}
