...
@XmlRootElement(name = "AACUIs")
public class AACUIs {

    @XmlAttribute(name = "Count", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String count;
    @XmlElement(name = "AACUI")
    protected List<AACUI> aacui;
    ...
    /**
     * Gets the value of the aacui property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the aacui property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAACUI().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AACUI> getAACUI() {
        if (aacui == null) {
            aacui = new ArrayList<AACUI>();
        }
        return this.aacui;
    }
