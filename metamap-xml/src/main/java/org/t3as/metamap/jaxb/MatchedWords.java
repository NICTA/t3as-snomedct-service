...
@XmlRootElement(name = "MatchedWords")
public class MatchedWords {

    @XmlAttribute(name = "Count", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String count;
    @XmlElement(name = "MatchedWord", required = true)
    protected List<MatchedWord> matchedWord;
    ...
    /**
     * Gets the value of the matchedWord property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the matchedWord property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMatchedWord().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<MatchedWord> getMatchedWord() {
        if (matchedWord == null) {
            matchedWord = new ArrayList<MatchedWord>();
        }
