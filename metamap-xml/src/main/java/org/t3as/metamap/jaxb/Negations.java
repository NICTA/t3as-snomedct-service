...
public class Negations {
    ...
    protected List<Negation> negation;
     ...
     * This is why there is not a <CODE>set</CODE> method for the negation property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNegation().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Negation> getNegation() {
        if (negation == null) {
            negation = new ArrayList<Negation>();
        }
